...
export default function SobrePage() {
  return (
    <main className="relative flex-1">
      <h1 className={`text-3xl font-black mt-12`}>Prazer, <span className="text-yellow-400">sou Sandro Luz</span></h1>

      <div className="text-zinc-400 font-light max-w-xl space-y-6 mt-8">
      ...
      <p className={`${islandMoments.className} text-4xl mt-8`}>Sandro Luz</p>
      <Image width={380} src={portrait} alt="Retrato de Sandro Luz"
        className="absolute right-0 -bottom-20 h-auto"
      />
